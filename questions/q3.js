...
// Explanation: In each instance variable dog1, cat1, it has its own copy of formatAge method (memory inefficiency). However the formatAge2 will only be added once to the Pet.prototype (memory efficient).

// Test
console.log(dog1.formatAge());
console.log(dog1.formatAge2());
